...
public interface HorseService {
  /**
   * Search for horses in the persistent data store matching all provided fields. The name is
   * considered a match, if the search string is a substring of the field in horse.
   *
   ...
   * @throws NotFoundException   if the horse with given ID does not exist in the persistent data
   *                             store
